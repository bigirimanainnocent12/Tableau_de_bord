...
with col1:
    ...
    st.markdown('<div class="chart-title">Somme des Ventes par Région</div>', unsafe_allow_html=True)
    ...
    fig_region.update_traces(
        ...
        pull=[0.05, 0.05, 0.05, 0.05]  # Séparer légèrement les segments
    )
...
with col2:
    st.markdown('<div class="small-chart-container">', unsafe_allow_html=True)
    st.markdown('<div class="chart-title">Somme des Ventes par Segment</div>', unsafe_allow_html=True)
...
with col3:
    st.markdown('<div class="small-chart-container">', unsafe_allow_html=True)
    st.markdown('<div class="chart-title">Somme des Ventes par Mode de Paiement</div>', unsafe_allow_html=True)
